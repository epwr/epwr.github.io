...
Let me run it on an understandable platform. An Ubuntu LTS is not be optimized for startup time, but it has what I need and I can run it locally when something breaks.
